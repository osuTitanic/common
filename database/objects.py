...
class DBUser(Base):
    ...
    relationships  = relationship('DBRelationship', back_populates='user', join_depth=2)
    ...
    achievements   = relationship('DBAchievement', back_populates='user', join_depth=2)
    screenshots    = relationship('DBScreenshot', back_populates='user', join_depth=2)
    favourites     = relationship('DBFavourite', back_populates='user', join_depth=2)
    ...
    badges         = relationship('DBBadge', back_populates='user', join_depth=2)
    names          = relationship('DBName', back_populates='user', join_depth=2)
